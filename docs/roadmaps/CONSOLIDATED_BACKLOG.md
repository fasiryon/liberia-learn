...
| NR-12 Critical Grade Deserts | **VALID.** Requires live coverage evidence for Grades 2 and 9. The curriculum risk-triage prerequisite is COMPLETE on `feat/curriculum-risk-triage` as of 2026-08-04, pending human review/merge; new automated Grade 2/9 approvals must use that shared path. |
