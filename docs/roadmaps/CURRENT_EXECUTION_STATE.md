...
- Quality uplift: every lesson includes a real objective, explicit skill,
  actual learner-facing materials, worked examples or solutions, guided and
  independent transfer, classwork, group work, homework, projects, labs where
  appropriate, misconception repair, remediation, extension, teacher guidance,
