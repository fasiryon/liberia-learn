...
-- CreateEnum
CREATE TYPE "MasteryMeasurementType" AS ENUM ('FORMATIVE', 'SUMMATIVE');

-- CreateEnum
CREATE TYPE "EvidenceSourceType" AS ENUM ('ASSESSMENT', 'ASSIGNMENT', 'PROJECT', 'LAB', 'OBSERVATION', 'OTHER');

-- CreateEnum
CREATE TYPE "InterventionType" AS ENUM ('TUTORING', 'RETEACH', 'PEER_SUPPORT', 'RESOURCE', 'COUNSELING', 'OTHER');

-- CreateEnum
CREATE TYPE "CohortType" AS ENUM ('CLASS', 'GRADE_LEVEL', 'SCHOOL', 'COUNTY', 'NATIONAL');
