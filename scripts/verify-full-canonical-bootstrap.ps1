...
try {
  ...
  if ($tableRls -ne "237|237") { throw "Expected 237/237 public tables with RLS, received $tableRls" }
  ...
  Write-Output "migrations=$($migrationNames.Count) tables=237 rls=237 p2cGrants=0 layeredDiffs=$(@($diffReport.diffStatementKeys).Count)"
