// route-policy: auth=session; scope=record; authority=retired-client-placement; rationale=placement items are issued only inside a server-held session; replaced by /api/student/placement/sessions
