...
import { retainStudents } from "@/lib/academics/promotion";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const result = await retainStudents(
      schoolId,
    ...
    return handleApiError(error, { requestId, route: "/api/admin/promotions/retain", method: "POST" });
  }
}
