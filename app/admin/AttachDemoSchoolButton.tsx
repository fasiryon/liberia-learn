  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="rounded-xl bg-[var(--ll-yellow)] px-5 py-3 text-sm font-semibold text-[var(--ll-bg)] shadow-lg shadow-emerald-500/30 hover:opacity-90 disabled:opacity-50"
      >
