          ...
          <>
            <div className="relative my-2">
              <div className="absolute inset-0 flex items-center">
                <span className="w-full border-t border-[var(--ll-border)]" />
              </div>
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-[var(--ll-bg)] px-2 text-[var(--ll-text-faint)]">or</span>
              </div>
            </div>
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--ll-border)] bg-[var(--ll-bg)]/70 px-4 py-2.5 text-sm font-medium text-[var(--ll-text)] shadow-sm hover:bg-[var(--ll-surface)] transition"
            >
