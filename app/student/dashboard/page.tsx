    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm text-gray-600">Massa Kamara</span>
        ...
        <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <h1 className="mb-8 text-3xl font-bold text-gray-900">Student Dashboard</h1>
  
          {/* Stats Cards */}
          <div className="mb-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-xl bg-white p-6 shadow-lg">
              <div className="mb-2 text-sm font-medium text-gray-600">My Classes</div>
              <div className="text-3xl font-bold text-blue-600">1</div>
            </div>
            <div className="rounded-xl bg-white p-6 shadow-lg">
              <div className="mb-2 text-sm font-medium text-gray-600">Attendance</div>
              <div className="text-3xl font-bold text-green-600">100%</div>
            </div>
            <div className="rounded-xl bg-white p-6 shadow-lg">
              <div className="mb-2 text-sm font-medium text-gray-600">Assignments</div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-lg border border-gray-200 p-4 hover:bg-gray-50">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Mathematics • Ms. Johnson</p>
                </div>
