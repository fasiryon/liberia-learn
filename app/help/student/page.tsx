...
import { STUDENT_HELP_ARTICLES } from "@/lib/support/implementationPlaybook";
...
export default function StudentHelpPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-10 px-6 py-12">
      ...
      <div>
        <h1 className="text-2xl font-bold text-[var(--ll-text)]">Student Guide</h1>
        <p className="mt-2 text-[var(--ll-text-muted)]">
          Find daily work, complete lessons, and track learning progress.
        </p>
      </div>

      <div className="space-y-6">
        {STUDENT_HELP_ARTICLES.map((article) => (
