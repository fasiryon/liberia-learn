...
import { GUARDIAN_HELP_ARTICLES } from "@/lib/support/implementationPlaybook";
...
export default function GuardianHelpPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-10 px-6 py-12">
      ...
      <div>
        <h1 className="text-2xl font-bold text-[var(--ll-text)]">Guardian Guide</h1>
        <p className="mt-2 text-[var(--ll-text-muted)]">
          Review learner progress and communicate with the school.
        </p>
      </div>

      <div className="space-y-6">
        {GUARDIAN_HELP_ARTICLES.map((article) => (
