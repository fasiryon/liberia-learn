  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center">
      <div className="rounded-xl border border-red-500/20 bg-[var(--ll-bg)]/70 p-8 text-center max-w-md">
        ...
        <p className="text-xs text-[var(--ll-text-muted)] mb-4">Please try again or return to your dashboard.</p>
        <div className="flex gap-3 justify-center">
          ...
          <a href="/teacher/dashboard" className="rounded-xl bg-[var(--ll-yellow)] px-4 py-2 text-sm text-[var(--ll-text)] hover:bg-[var(--ll-yellow-soft)]">Return to Dashboard</a>
        </div>
      </div>
    </div>
  );
