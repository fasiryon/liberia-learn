  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center">
      <div className="rounded-2xl border border-red-500/20 bg-slate-900/70 p-8 text-center max-w-md">
        ...
        <p className="text-xs text-slate-400 mb-4">Please try again or return to the platform dashboard.</p>
        <div className="flex gap-3 justify-center">
          ...
          <a href="/platform" className="rounded-xl bg-violet-500 px-4 py-2 text-sm text-white hover:bg-violet-400">Return to Dashboard</a>
        </div>
      </div>
    </div>
  );
