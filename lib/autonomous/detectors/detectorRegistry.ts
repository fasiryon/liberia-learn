...
export const detectorRegistry: Record<DetectorId, DetectorDefinition> = {
  "student-risk": {
    ...
    allowedEventTriggers: ["mastery.snapshot.created", "attendance.recorded", "assessment.submitted", "assignment.updated", "lesson.completed", "assignment.submitted"],
    requiredEvidence: ["MasterySnapshot", "Attendance", "AssessmentAttempt", "StudentProgress", "LearningEvent"],
    riskCeiling: "medium",
  ...
  "teacher-support": {
    ...
    scope: "teacher",
    allowedTenantScopes: ["school"],
    allowedEventTriggers: ["assignment.created", "assignment.submitted", "assignment.graded", "intervention.updated", "curriculum.flag.created", "teacher.feedback.created"],
  ...
  "curriculum-gap": {
    ...
    allowedEventTriggers: ["assessment.submitted", "curriculum.flag.created", "lesson.completed", "ai.interaction", "discussion.post.created"],
  ...
  "school-compliance": {
    ...
    scope: "school",
    allowedTenantScopes: ["school"],
    allowedEventTriggers: ["workflow.checkpointed", "lesson.delivered", "report.generated", "report_card.generated", "attendance.updated", "live_session.attendance_marked"],
  ...
  "guardian-communication": {
    ...
    scope: "guardian",
    allowedTenantScopes: ["school"],
    allowedEventTriggers: ["mastery.snapshot.created", "attendance.recorded", "intervention.updated", "guardian.report_card.viewed", "push.notification.opened"],
    requiredEvidence: ["MasterySnapshot", "Attendance", "Intervention", "GuardianMessage", "LearningEvent"],
    riskCeiling: "medium",
  ...
  "moe-governance": {
    ...
    allowedEventTriggers: ["aggregate.metric.updated", "policy.check.completed", "report_card.published", "attendance.updated"],
  ...
  "national-trend": {
    ...
    allowedEventTriggers: ["aggregate.metric.updated", "lesson.completed", "assignment.graded", "attendance.updated"],
