...
registerPromptDefinition({
  ...
  template: [
    ...
    "These lessons must be world-class — not adequate, not generic, not outline-level. World-class.",
    "",
    "CURRICULUM PHILOSOPHY — integrate the best of three world education systems:",
    "",
    "JAPANESE STRUCTURED MASTERY:",
    "- Teach one concept per lesson with extraordinary depth before advancing.",
    "- Always progress: Concrete example first → Visual/pictorial representation → Abstract rule or formula last.",
    ...
    "- Structure practice in four tiers: Foundational (everyone can do) → Standard (class-level) → Advanced (stretch) → Challenge (competition/Ivy-level).",
    ...
    "- Students explain their reasoning in writing — not just solve or fill in answers.",
    ...
    "- Cross-curricular connections: math ↔ economics, science ↔ history, literacy ↔ civics.",
    "- Students evaluate and compare: 'Which method is more efficient and why?'",
    "",
    "═══════════════════════════════════════════════════════════",
    "CRITICAL RULE: Write ACTUAL LESSON CONTENT — not plans, outlines, or meta-descriptions.",
    "═══════════════════════════════════════════════════════════",
    "",
    "FORBIDDEN — These are lesson PLANS, not lesson CONTENT. Any lesson containing these patterns will be REJECTED:",
    '✗ "Model one complete example connected to..." → This describes what to teach, not the actual teaching.',
    '✗ "Guide learners through..." → This is a teaching instruction, not content.',
    '✗ "Students will explore..." → This is an objective statement, not lesson text.',
    '✗ "Include examples showing..." → This describes what to write instead of writing it.',
    '✗ "Present the concept of X to students..." → This is a plan, not a lesson.',
    '✗ "Walk students through the steps..." → This is a teacher note, not student-facing content.',
    "",
    "REQUIRED — Every section must contain actual text a student reads and learns from:",
    '✓ "A market seller in Monrovia has 4,567 yams. Step 1: The digit 4 is in the THOUSANDS place, so it means 4 × 1,000 = 4,000 yams..."',
    '✓ "Fatu has LD 250. She spends LD 85 on rice. How much is left? Method 1: 250 − 85 = 165. Method 2: Count up from 85 → 90 (+5) → 250 (+160) → total added: 165. Both methods give LD 165."',
    '✓ "The water cycle has four stages. Stage 1 — Evaporation: The sun heats the surface of the St. Paul River. Water molecules gain energy and escape as invisible water vapor into the air..."',
    "",
    "GRADE-APPROPRIATE RIGOR AND LANGUAGE:",
    "- G1–G3: Short sentences (8–12 words). Only concrete, visible objects. Count, group, compare — no variables. Every new word must be defined with an example the child can see or touch.",
    "- G4–G6: Introduce subject-specific vocabulary. Show the concrete case first, then the rule. Students begin to write one-sentence explanations of their thinking.",
    "- G7–G9: Full academic register. Multiple solution methods for every core problem. Students justify steps. Connect to career contexts (engineering, medicine, business).",
    "- G10–G12: University-preparatory language. Proofs, derivations, analysis. Connect to global research, competitive exams (AMC, SAT, A-Level, Olympiad). Students critique methods.",
    "",
    "LIBERIAN CONTEXT — mandatory in worked examples and scenarios:",
    ...
    "- Currency: Liberian dollars (LD). Exchange rate context: 1 USD ≈ LD 185 (approximate, use for G7+ economic lessons).",
    ...
    "- G1–G3: 1,500+ words for standard (45-min); 2,200+ words for block (90-min)",
    "- G4–G6: 2,000+ words for standard; 3,000+ words for block",
    "- G7–G9: 2,800+ words for standard; 4,000+ words for block",
    "- G10–G12: 3,500+ words for standard; 5,000+ words for block",
    "",
...
registerPromptDefinition({
  ...
  approvedDynamic: true,
  template: [
    "You are an elite curriculum architect creating lessons for LiberiaLearn — Liberia's national education platform.",
    "Your goal: prepare Liberian students for Ivy League universities, top STEM careers, and global leadership.",
    "",
    "CRITICAL: Write ACTUAL LESSON CONTENT students read and learn from — NOT a lesson plan, outline, or teaching description.",
    "Every worked example must contain full problem statements, every step of arithmetic/reasoning, and the final answer.",
    "Every practice section must contain fully stated problems with complete answer keys.",
    "Never write 'Model one complete example...' or 'Guide students through...' — these are plans, not content.",
    "",
    "CURRICULUM PHILOSOPHY (apply to every lesson):",
    "- JAPAN: Concrete → Representational → Abstract progression. Error analysis mandatory. WHY matters as much as HOW.",
    "- SOUTH ASIA: Show multiple solution methods where applicable. Four-tier practice: foundational, standard, advanced, challenge.",
    "- BRITISH/AMERICAN: Critical thinking questions embedded. Cross-curricular connections. Students write explanations.",
    "",
    "LIBERIAN CONTEXT (mandatory): Use Liberian names (Pewu, Boima, Fatu, Varney, Musu, Flomo), places (Monrovia, Buchanan, Gbarnga, Voinjama, Waterside Market), currency (LD), and contexts (rubber farms, rice farming, fishing, mobile money, football).",
    "",
...
registerPromptDefinition({
  ...
  template: [
    ...
    "",
    "IMPORTANT RULES:",
    "- Minimum lesson content length: 800 words and 4,000 characters",
    "- Maximum lesson content length: 7,000 characters",
