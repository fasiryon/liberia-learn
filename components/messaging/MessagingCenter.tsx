...
export function MessagingCenter({ role, emptyState }: MessagingCenterProps) {
  ...
  if (loading) {
    return (
      <div className="grid gap-4 lg:grid-cols-[320px,1fr]">
        ...
        <div className="h-[420px] animate-pulse rounded-3xl bg-slate-800/50" />
      </div>
    );
  }
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[320px,1fr]">
      <aside className="rounded-3xl border border-white/10 bg-slate-900/70 p-3">
      ...
      <section className="flex min-h-[460px] flex-col rounded-3xl border border-white/10 bg-slate-900/70">
        ...
        <div className="border-t border-white/10 px-5 py-4">
          <div className="flex flex-col gap-3 sm:flex-row">
            <textarea
              ...
              className="min-h-11 flex-1 rounded-2xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm text-slate-100 outline-none focus:border-emerald-500"
            />
            <button
              type="button"
              onClick={handleSend}
              disabled={sending || !draft.trim()}
              className="min-h-11 rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-slate-950 hover:bg-emerald-400 disabled:opacity-60"
            >
