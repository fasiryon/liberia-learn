  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap gap-3">
        <button type="button" onClick={handleSendSms} disabled={sending} className="min-h-11 rounded-xl bg-[var(--ll-yellow)] px-4 py-3 text-sm font-semibold text-[var(--ll-bg)] hover:opacity-90 disabled:opacity-60">
