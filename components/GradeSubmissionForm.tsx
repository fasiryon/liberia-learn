    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      <div className="flex items-center gap-3">
        ...
        <button
          type="submit"
          disabled={saving}
          className="mt-5 rounded-lg bg-[var(--ll-yellow)] px-4 py-2 text-xs font-semibold text-[var(--ll-bg)] hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {saving
            ? "Saving..."
            : initialScore !== null
